...
[<img src="logo.svg" align="right" width="100">](https://github.com/balintkissdev/awesome-dos) ⭐ 595 | 🐛 1 | 📅 2025-08-25
...
* [Open Watcom V2](https://github.com/open-watcom/open-watcom-v2) ⭐ 1,170 | 🐛 275 | 🌐 C | 📅 2026-03-14 - GitHub fork which is actively maintained and is
...
* [386MAX](https://github.com/sudleyplace/386MAX) ⭐ 135 | 🐛 0 | 🌐 Assembly | 📅 2022-07-05 - Memory manager for DOS PCs with 386 or higher CPUs, [released by Qualitas company in 1992](https://winworldpc.com/product/386max/6x). Source code was released in June 2022 on GitHub with GPL-3.0 license.
...
* [Micropython for FreeDOS](https://github.com/pohmelie/micropython-freedos) ⭐ 28 | 🐛 1 | 🌐 C | 📅 2016-10-26 - FreeDOS ad-hoc module for [micropython](https://github.com/micropython/micropython) ⭐ 21,536 | 🐛 1,850 | 🌐 C | 📅 2026-03-11.
...
* [Allegro 4.2](https://github.com/liballeg/allegro5/tree/v4-2-3-1) ⭐ 2,076 | 🐛 383 | 🌐 C | 📅 2026-02-23 - Game development library for DOS, Windows and Linux. 4.2 version supports DOS platform.
...
* [NetHack](https://github.com/NetHack/NetHack) ⭐ 3,507 | 🐛 158 | 🌐 C | 📅 2026-03-13 - Descendant of the original [NetHack](https://en.wikipedia.org/wiki/NetHack) rougelike game first released in 1987 available on multiple platforms.
...
* [Commander Keen in Keen Dreams](https://github.com/keendreams/keen) ⭐ 1,961 | 🐛 5 | 🌐 C | 📅 2014-11-12 - Side-scrolling platform game developed by id Software. Keen Dreams is the Commander Keen game created between Keen 3 and Keen 4 (often considered "Keen 3.5"), but was not widely released. Written in C and assembly.
...
* [Catacomb 3D](https://github.com/CatacombGames/Catacomb3D) ⭐ 202 | 🐛 0 | 🌐 C++ | 📅 2014-06-05 - First-person shooter in fantasy setting developed by Softdisk (later becoming id Software). Features pseudo-3D graphics with raycasting technique. Supports EGA graphics. Written in C and assembly. Compiled with Borland C++ 3.1.
...
* [VSB](https://github.com/Baron-von-Riedesel/VSBHDA) ⭐ 132 | 🐛 39 | 🌐 C | 📅 2025-12-26 - A fork of SBEMU (see above), which also aims to offer Sound Blaster emulation for modern PC hardware, in both real mode and protected mode games.
